...
class TestSafeJsonParse:
    """Test the standalone safe_json_parse function."""
    ...
    def test_valid_json(self):
        ...
        result = safe_json_parse(mock_response, "test context")
    ...
    def test_provider_api_client_exposes_safe_json_parse(self):
        """ProviderAPIClient.safe_json_parse should delegate to json_parser."""
        from app.utils.api_client import ProviderAPIClient
        ...
        result = client.safe_json_parse(mock_response)
...
class TestDRMConsolidation:
    """DRM processors are importable from the drm package."""
    ...
    def test_active_processors_importable(self):
        """Active DRM processor modules should be importable."""
...
class TestMetadataMovedToProvidersFr:
    ...
    def test_both_paths_resolve_to_same_class(self):
        ...
        from app.providers.fr.metadata import FranceTVMetadataProcessor as B
        assert A is B
    ...
    def test_sixplay_does_not_import_from_legacy_path(self):
        import pathlib
        src = pathlib.Path("app/providers/fr/sixplay.py").read_text(encoding='utf-8')
        assert "app.utils.metadata" not in src
