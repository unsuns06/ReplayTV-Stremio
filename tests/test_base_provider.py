...
class TestProviderAPIClientBehavior:
    """Verify ProviderAPIClient has the required interface."""

    def test_provider_api_client_has_required_attributes(self):
        """ProviderAPIClient should have session, timeout, max_retries, and safe_json_parse."""
